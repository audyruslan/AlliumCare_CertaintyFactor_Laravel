                        ...
                        <ul class="list-group">
                            @foreach ($hama as $hamas)
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <span><b> {{ $hamas->name }}</b></span>
                                    <a class="btn btn-primary btn-sm" data-bs-toggle="collapse"
                                        data-bs-target="#collapseExample{{ $hamas->id }}" aria-expanded="false"
                                ...
                                <div class="collapse list-group-item list-group-item-action"
                                    ...
                                    <table class="table table-striped" id="table1">
                                        ...
                                        <tbody>
                                            @foreach ($ruleshama as $data)
                                                @if ($data->hama_id == $hamas->id)
                                                    <tr>
                                                        <td>{{ $data->gejalahama->code }}</td>
                                                        <td>{{ $data->gejalahama->name }}</td>
                                                        <td class="align-middle" style="width: 30%">
                                                            @if ($setting_type_input->input_type == 'input')
